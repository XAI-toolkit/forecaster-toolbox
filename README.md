...
|    project         |    The project ID for which the forecasts will   be produced.           |        Yes       |    Currently the following string values are   supported for testing purposes:   ·           TD Forecaster: ‘apache_kafka_measures’   ·           Security Forecaster: ‘square_retrofit_security_measures’   ·           Energy Forecaster: ‘sbeamer_gapbs_energy_measures’   Later, this input will be the ID of an   actual project integrated into the SDK4ED platform. This ID is required in   order to fetch from the relevant TD, Energy and Dependability DBs the indicators   described in Table 4, Table 5 and Table 6   for   multiple versions of the project.    |
|    regressor       |    The regressor model that will be used to   produce forecasts.        |        No        |    One of the following string values: [‘auto’, ‘mlr’, ‘lasso’, ‘ridge’, ‘svr_linear’, ‘svr_rbf’, ‘random_forest’, ‘arima’].    Default value is ‘auto’.                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
|    test            |    If the model will produce Train-Test or   unseen forecasts.          |        No        |    One of the following string values:[‘yes’, ‘no’].   Default value is ‘no’.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
